...
# 这里也需要设置 default
parser.add_argument('--weight_diff', help="weight hyperparm to control differential behavior", type=float, default=0)
parser.add_argument('--weight_nc', help="weight hyperparm to control neuron coverage", type=float,default=0)
parser.add_argument('--step', help="step size of gradient descent", type=float, default=0)
# 这里设置了 defualt 参数
parser.add_argument('--seeds', help="number of seeds of input", type=int, default=30)
parser.add_argument('--grad_iterations', help="number of iterations of gradient descent", type=int, default=0)
...
for _ in range(args.seeds):
    ...
    if not label1 == label2 == label3:
        ...
        imageio.imsave('./generated_inputs/' + 'already_differ_' + str(label1) + '_' + str(
            label2) + '_' + str(label3) + '.png', gen_img_deprocessed)
        continue
    ...
    # 定义 loss 1 2 3 的类型we
    # loss1 = tensorflow.Variable
    # loss2 = tensorflow.Variable
    # loss3 = tensorflow.Variable
    ...
    for iters in range(args.grad_iterations):
        ...
        if not predictions1 == predictions2 == predictions3:
            ...
            # save the result to disk
            imageio.imsave('./generated_inputs/' + args.transformation + '_' + str(predictions1) + '_' + str(
